...
<head>
    ...
    <title>Queue System Controller(CASHIER)</title>
    <style>
         body {
            background: white;
            display: flex;
...
<div class="container">
    <h1 class="dashboard">CASHIER CONTROLLER</h1>
    <h2 style="color: black; font-weight: bold;">
        ...
        <form action="{{ route('next.student2') }}" method="POST">
            @csrf
    ...
    <script>
        ...
        function speak(text) {
            var customText = "Please proceed to the Cashier Department." + text;
