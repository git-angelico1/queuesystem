...
<body>
    ...
    <div class="department-cards">
        <div class="department-card">
            ...
            <button class="proceed-button" onclick="redirectToDepartment('cashier')">LOGIN</button>
        </div>
        <div class="department-card" >
            <h3>Registrar Department</h3>
            <img src="registrar.png" alt="Registrar Image">
            <button class="proceed-button" onclick="redirectToDepartment('registrar')">LOGIN</button>
        </div>
        <div class="department-card" >
            <h3>Finance Department</h3>
            <img src="finance.png" alt="Finance Image">
            <button class="proceed-button" onclick="redirectToDepartment('finance')">LOGIN</button>
        </div>
    </div>
